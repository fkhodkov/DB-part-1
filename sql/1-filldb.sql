...
INSERT INTO vacancy(
  ...
  description
    ...
    (1, 'Менеджер по продажам', 'Москва', 'Продажи', numrange(25000, 35000), 1, 'full_time',
    'Лучший в мире менеджер по продажам для лучшей в мире компании!'),
    (1, 'Генеральный директор', 'Москва', 'Продажи', numrange(150000, 200000), 5, 'full_time',
...
График свободный, оплата сдельная'),
    (2, 'Java-программист', 'Москва', 'IT', numrange(75000, 120000), 2, 'full_time',
...
Наличие open-source разработок в портфолио будет плюсом.'),
    (2, 'Программист C++', 'Челябинск', 'IT', numrange(NULL, 130000), 1, 'full_time',
...
INSERT INTO resume(
  ...
  text
    ...
    numrange(25000, 35000), 1, 'full_time',
    'Опыт работы:
1. Сентябрь 2016-Ноябрь 2017. ООО Березка, Курьер
2. Ноябрь 2017-Настоящее время. ООО Березка, Менеджер по продажам'),
    (1, 'Курьер', 'Продажи', 'Москва', numrange(15000, NULL), 1, 'part_time',
    'Опыт работы:
1. Сентябрь 2016-Ноябрь 2017. ООО Березка, Курьер
2. Ноябрь 2017-Настоящее время. ООО Березка, Менеджер по продажам'),
    (2, 'Java-программист', 'Красногорск', 'IT', numrange(50000, NULL), 1, 'full_time',
    'Опыт работы:
1. Апрель 2017-Декабрь 2018. Программист Java, ЗАО АБВГДБанк'),
    (3, 'Генеральный директор', 'Москва', 'Продажи', numrange(250000, 300000), 5, 'full_time',
    'Опыт работы:
...
2. Август 2015-Настоящее время. Руководитель департамента меда, ЗАО Темный лес'),
    (4, 'Java-программист', 'Москва', 'IT', numrange(75000, 120000), 3, 'full_time',
    'Опыт работы:
