...
INSERT INTO vacancy(
  ...
  description
    ...
    (1, 'Менеджер по продажам', 'Москва', 'Продажи', INT4RANGE(25000, 35000), 1, 'FULL_TIME',
    'Лучший в мире менеджер по продажам для лучшей в мире компании!'),
    (1, 'Генеральный директор', 'Москва', 'Продажи', INT4RANGE(150000, 200000), 5, 'FULL_TIME',
    'Лучший в мире генеральный директор для лучшей в мире компании!'),
    (1, 'Курьер', 'Продажи', 'Тула', NULL, NULL, 'FLEXIBLE',
    'Лучший в мире курьер для лучшей в мире компании!
График свободный, оплата сдельная'),
    (2, 'Java-программист', 'Москва', 'IT', INT4RANGE(75000, 120000), 2, 'FULL_TIME',
...
Наличие open-source разработок в портфолио будет плюсом.'),
    (2, 'Программист C++', 'Челябинск', 'IT', INT4RANGE(NULL, 130000), 1, 'FULL_TIME',
...
INSERT INTO resume(
  ...
  text
    ...
    (1, 'Менеджер по продажам', 'Москва', 'Продажи',
    INT4RANGE(25000, 35000), 1, 'FULL_TIME',
    'Опыт работы:
1. Сентябрь 2016-Ноябрь 2017. ООО Березка, Курьер
2. Ноябрь 2017-Настоящее время. ООО Березка, Менеджер по продажам'),
    (1, 'Курьер', 'Продажи', 'Москва', INT4RANGE(15000, NULL), 1, 'PART_TIME',
    'Опыт работы:
1. Сентябрь 2016-Ноябрь 2017. ООО Березка, Курьер
2. Ноябрь 2017-Настоящее время. ООО Березка, Менеджер по продажам'),
    (2, 'Java-программист', 'Красногорск', 'IT', INT4RANGE(50000, NULL), 1, 'FULL_TIME',
    'Опыт работы:
1. Апрель 2017-Декабрь 2018. Программист Java, ЗАО АБВГДБанк'),
    (3, 'Генеральный директор', 'Москва', 'Продажи', INT4RANGE(250000, 300000), 5, 'FULL_TIME',
    'Опыт работы:
...
2. Август 2015-Настоящее время. Руководитель департамента меда, ЗАО Темный лес'),
    (4, 'Java-программист', 'Москва', 'IT', INT4RANGE(75000, 120000), 3, 'FULL_TIME',
    'Опыт работы:
